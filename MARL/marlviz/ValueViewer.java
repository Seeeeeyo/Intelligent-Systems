...
public class ValueViewer extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		for (int y = (int) minValue; y<maxValue*1.05; y++) {
			g2d.drawLine(getXFor(0), getYFor(y), getXFor(maxEntries), getYFor(y));
			g2d.drawString(String.valueOf(y), getXFor(0)-20, getYFor(y));
		}
